...
day_df = pd.read_csv('https://raw.githubusercontent.com/Jessica1711/Analisis-Data-dengan-Python-Bike-Sharing-Dataset-/refs/heads/main/data/day.csv')
hour_df = pd.read_csv('https://raw.githubusercontent.com/Jessica1711/Analisis-Data-dengan-Python-Bike-Sharing-Dataset-/refs/heads/main/data/hour.csv')
...
# Display data
st.header("Data")
st.text("Berikut adalah dua data yang akan saya gunakan untuk proses analisis data dengan python")
